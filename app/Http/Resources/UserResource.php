...
class UserResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'avatar' => $this->avatar ? Storage::disk('public')->url($this->avatar) : Storage::disk('public')->url('/img/default_avatar.jpg'),
            'overlay' => $this->overlay ? Storage::disk('public')->url($this->overlay) : Storage::disk('public')->url('/img/default_overlay.jpg'),
