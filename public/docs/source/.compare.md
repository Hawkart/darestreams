...
$response = $client->post("https://darestreams.com/api/streams", [
    ...
    'json' => [
            ...
            "min_amount_donate_task_before_stream" => "debitis",
...
$response = $client->put("https://darestreams.com/api/streams/1", [
    ...
    'json' => [
            ...
            "min_amount_task_when_stream" => "explicabo",
            "min_amount_donate_task_before_stream" => "sit",
            "min_amount_donate_task_when_stream" => "quibusdam",
            "tags" => "nesciunt",
        ],
]);
$body = $response->getBody();
...
$response = $client->put("https://darestreams.com/api/tasks/1", [
    ...
    'json' => [
            "status" => "9",
            "small_text" => "perferendis",
            "full_text" => "repellendus",
            "interval_time" => "10",
            "is_superbowl" => "1",
            "tags" => "aliquam",
        ],
