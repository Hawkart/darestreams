...
$response = $client->post("https://darestreams.com/api/streams", [
    ...
    'json' => [
            ...
            "min_amount_task_before_stream" => "quam",
            "min_amount_task_when_stream" => "voluptates",
            "min_amount_donate_task_before_stream" => "adipisci",
            "min_amount_donate_task_when_stream" => "maxime",
            "tags" => "deleniti",
        ],
]);
$body = $response->getBody();
...
$response = $client->put("https://darestreams.com/api/streams/1", [
    ...
    'json' => [
            ...
            "min_amount_task_before_stream" => "nam",
            "min_amount_task_when_stream" => "dolorem",
            "min_amount_donate_task_before_stream" => "tempore",
